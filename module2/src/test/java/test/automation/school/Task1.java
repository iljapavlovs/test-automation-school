...
//        todo 2. Зайти на ss.com
    ...
    public void testSearch() throws Exception {
        ...
        WebElement switchLangLink = driver.findElement(By.cssSelector(".menu_lang a"));
//        3. todo Поменять язык на русский.
        // change language only if
        if (switchLangLink.getAttribute("href").contains("ru")) {
...
//       todo 4. в поиске ввести искомую фразу(напр.Компьютер....)
        ...
        searchLinkWait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("#main_table a[href*='search']")));
...
//        wait.until(ExpectedConditions.elementToBeClickable(driver.findElement(By.id("ptxt"))));
        ...
        System.out.println("Is hunja shown: " + driver.findElements(By.id("preload_txt")).size());
