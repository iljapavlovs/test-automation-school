...
public class WebElementActionExample2 {
    public static void main(String[] args) {
        ...
        inptSearch.sendKeys(Keys.chord(Keys.CONTROL, "A"));
        inptSearch.sendKeys("new banana");

        List<WebElement> divSearchResultsList = driver.findElements(By.cssSelector(".g"));

        WebElement a = divSearchResultsList.get(0).findElement(By.cssSelector("a"));
        a.click();
